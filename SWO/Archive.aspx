<%@ Page Language="VB" MasterPageFile="~/LoggedIn.master" AutoEventWireup="false" CodeFile="Archive.aspx.vb" Inherits="Archive" %>
    ...
    <AJAX:UpdatePanel ID="AJAXUpdatePanel" runat="server">
        <ContentTemplate>
            ...
            <table width="100%" align="center">
                <tr>
                    <td align="center">
                        <font size="6"><b>Archived Incidents</b></font>
                    </td>
                </tr>
            </table>
            <br />
            <table width="100%" align="center">
                <tr>
                    <td  align="center">
                        ...
                        <asp:DropDownList ID="ddlIncidentType" Width="250px" DataTextField="IncidentType" DataValueField="IncidentTypeID" runat="server" AutoPostBack="true"></asp:DropDownList>
                    </td>
                </tr>
                <tr>
                    <td align="center">
                ...
                <tr>
                    <td>
                       <asp:DataGrid  ID="IncidentDataGrid" runat="server" Width="100%"
                            OnSortCommand="SortIncident" AutoGenerateColumns="false" 
                            AllowSorting="True" AllowPaging="True"  PagerStyle-HorizontalAlign="center"
                            OnPageIndexChanged="IncidentDataGrid_PageIndexChanged" 
                            HeaderStyle-CssClass="datagridheader" 
                            AlternatingItemStyle-CssClass="datagridalt" PageSize="100">
                            ...
                            <Columns>
                                ...
                                <asp:BoundColumn ItemStyle-HorizontalAlign="Center" DataField="IncidentNumber" SortExpression="IncidentID DESC" HeaderText="Incident # <img src='Images/blue_arrow_DOWN2.jpg' align='absmiddle' border=0>">
                                    <HeaderStyle HorizontalAlign="Center" Wrap="False"></HeaderStyle>
                                    <ItemStyle HorizontalAlign="Center" />
                                </asp:BoundColumn>
                        
                                <asp:BoundColumn ItemStyle-HorizontalAlign="Center" DataField="IncidentStatus" SortExpression="IncidentStatus ASC" HeaderText="Status">
                                    <HeaderStyle HorizontalAlign="Center" Wrap="False"></HeaderStyle>
                                    <ItemStyle HorizontalAlign="Center" />
                                </asp:BoundColumn>
                                  
                                <asp:BoundColumn ItemStyle-HorizontalAlign="Center" DataField="IncidentName" SortExpression="IncidentName ASC" HeaderText="Incident Name">
                                    <HeaderStyle HorizontalAlign="Center" Wrap="False"></HeaderStyle>
                                    <ItemStyle HorizontalAlign="Center" />
                                </asp:BoundColumn>
                        
                                <asp:BoundColumn ItemStyle-HorizontalAlign="Center" DataField="AddedCounty" SortExpression="AddedCounty ASC" HeaderText="County">
                                    <HeaderStyle HorizontalAlign="Center" Wrap="False"></HeaderStyle>
                                    <ItemStyle HorizontalAlign="Center" />
                                </asp:BoundColumn>
                        
                                <asp:BoundColumn HeaderStyle-Width="150px" ItemStyle-HorizontalAlign="Center" DataField="DateCreated" SortExpression="DateCreatedSort ASC" HeaderText="Date Created ET">
                                    <HeaderStyle HorizontalAlign="Center" Wrap="False"></HeaderStyle>
                                    <ItemStyle HorizontalAlign="Center" />
                                </asp:BoundColumn>
                        
                                <asp:BoundColumn HeaderStyle-Width="150px" ItemStyle-HorizontalAlign="Center" DataField="LastUpdated" SortExpression="LastUpdatedSort ASC" HeaderText="Last Updated ET">
                                    <HeaderStyle HorizontalAlign="Center" Wrap="False"></HeaderStyle>
                                    <ItemStyle HorizontalAlign="Center" />
                                </asp:BoundColumn>
