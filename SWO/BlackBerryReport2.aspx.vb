...
Partial Class BlackBerryReport2
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        "<head><title>Situational Awareness Report</title>")
            ...
            'msgEmail.Body = strBody.ToString
    ...
    Protected Sub GetMainForm()
        ...
        strBody.Append("            <b>FDEM SWO Situational Awareness Report</b>")
        strBody.Append("        </td>")
        strBody.Append("    </tr>")
        strBody.Append("</table>")
        ...
        localRecordAccountForArray = MrDataGrabber.GrabRecordCountByKey("IncidentIncidentType", "IncidentID", Request("IncidentID"))
        ...
        If IsExempt = True Then
            ...
            strBody.Append("<table>")
            strBody.Append("    <tr>")
            strBody.Append("        <td align='left' style='background-color:White; height:25px; color:#ff0000; font:Arial; font-size:1.1em;'> ")
        ...
        strBody.Append("         " & MrDataGrabber.GrabOneStringColumnByPrimaryKey("IncidentStatus", "IncidentStatus", "IncidentStatusID", MrDataGrabber.GrabOneIntegerColumnByPrimaryKey("IncidentStatusID", "Incident", "IncidentID", Request("IncidentID")).ToString).ToString & " ")
        strBody.Append("        </td>")
        strBody.Append("    </tr>")
        strBody.Append("</table>")
        ...
        strBody.Append("        " & ReportedToSWODate & " &nbsp; " & ReportedToSWOTime & ":" & ReportedToSWOTime2 & " EST ")
        strBody.Append("        </td>")
        strBody.Append("    </tr>")
        strBody.Append("</table>")
        ...
        strBody.Append("            " & IncidentOccurredDate & " &nbsp; " & IncidentOccurredTime & ":" & IncidentOccurredTime2 & " EST ")
        strBody.Append("        </td>")
        strBody.Append("    </tr>")
        strBody.Append("</table>")
        ...
        strBody.Append("        " & MrDataGrabber.GrabOneStringColumnByPrimaryKey("LastUpdated", "Incident", "IncidentID", Request("IncidentID")).ToString & " EST ")
        strBody.Append("        </td>")
        strBody.Append("    </tr>")
        strBody.Append("</table>")
    ...
    Private Sub GetHazardousMaterials(ByVal strIncidentID As String, ByVal strIncidentIncidentTypeID As String)
        ...
        ElseIf SubType = "Toxic Industrial Chemical" Then
            ...
            strBody.Append("           " & TimeReleaseDiscovered & " EST ")
            strBody.Append("        </td>")
            strBody.Append("    </tr>")
            strBody.Append("</table>")
            ...
            strBody.Append("           " & TimeReleaseSecured & " EST ")
            strBody.Append("        </td>")
            strBody.Append("    </tr>")
            strBody.Append("</table>")
    ...
    Private Sub GetDemINR(ByVal strIncidentID As String, ByVal strIncidentIncidentTypeID As String)
        ...
        ElseIf SubType = "IT Disruption or Issue" Then
            ...
            strBody.Append("           " & Left(localTime, 2) & ":" & Right(localTime, 2) & " &nbsp;EST ")
            strBody.Append("        </td>")
            strBody.Append("    </tr>")
            strBody.Append("</table>")
        ...
        ElseIf SubType = "Communications Disruption or Issue" Then
            ...
            strBody.Append("        <td align='left'width='400px'>")
            strBody.Append("            <b>Time the problem started:</b> ")
            strBody.Append("           " & Left(localTime2, 2) & ":" & Right(localTime2, 2) & " &nbsp;EST ")
            strBody.Append("        </td>")
            strBody.Append("    </tr>")
            strBody.Append("</table>")
        ...
        ElseIf SubType = "Planned Outage" Then
            ...
            strBody.Append("           " & Left(localTime3, 2) & ":" & Right(localTime3, 2) & " &nbsp;EST ")
            strBody.Append("        </td>")
            strBody.Append("    </tr>")
            strBody.Append("</table>")
    ...
    Private Sub GetKennedySpaceCenter(ByVal strIncidentID As String, ByVal strIncidentIncidentTypeID As String)
        ...
        ElseIf SubType = "Successful Launch" Then
            ...
            strBody.Append("           " & Left(localTime4, 2) & ":" & Right(localTime4, 2) & " &nbsp;EST ")
            strBody.Append("        </td>")
            strBody.Append("    </tr>")
            strBody.Append("</table>")
        ...
        ElseIf SubType = "Unsuccessful Launch" Then
            ...
            strBody.Append("        <td align='left'width='400px'>")
            strBody.Append("            <b>Launch time:</b> ")
            strBody.Append("           " & Left(localTime5, 2) & ":" & Right(localTime5, 2) & " &nbsp;EST ")
            strBody.Append("        </td>")
            strBody.Append("    </tr>")
            strBody.Append("</table>")
    ...
    Private Sub GetNPP(ByVal strIncidentID As String, ByVal strIncidentIncidentTypeID As String)
        ...
        ElseIf SubType = "Farley" Then
            ...
            strBody.Append("    <tr>")
            strBody.Append("        <td align='left'width='400px'>")
            strBody.Append("            Date = " & Far12ADate & " &nbsp;EST ")
            strBody.Append("        </td>")
            strBody.Append("    </tr>")
            strBody.Append("</table>")
            ...
            strBody.Append("    <tr>")
            strBody.Append("        <td align='left'width='400px'>")
            strBody.Append("            Time = " & Left(localTime7, 2) & ":" & Right(localTime7, 2) & " &nbsp;EST ")
            strBody.Append("        </td>")
            strBody.Append("    </tr>")
            strBody.Append("</table>")
            ...
            If Far14Bliquid = True Then
                ...
                strBody.Append("        <td align='left'width='400px'>")
                strBody.Append("            Start Time = ")
                strBody.Append("           " & Left(localTime10, 2) & ":" & Right(localTime10, 2) & " &nbsp;EST ")
                strBody.Append("        </td>")
                strBody.Append("    </tr>")
                strBody.Append("</table>")
                ...
                strBody.Append("        <td align='left'width='400px'>")
                strBody.Append("            Stop Time = ")
                strBody.Append("           " & Left(localTime11, 2) & ":" & Right(localTime11, 2) & " &nbsp;EST ")
                strBody.Append("        </td>")
                strBody.Append("    </tr>")
                strBody.Append("</table>")
            ...
            strBody.Append("        <td align='left'width='400px'>")
            strBody.Append("            Time = ")
            strBody.Append("           " & Left(localTime12, 2) & ":" & Right(localTime12, 2) & " &nbsp;EST ")
            strBody.Append("        </td>")
            strBody.Append("    </tr>")
            strBody.Append("</table>")
            ...
            strBody.Append("        <td align='left'width='400px'>")
            strBody.Append("            Time = ")
            strBody.Append("           " & Left(localTime13, 2) & ":" & Right(localTime13, 2) & " &nbsp;EST ")
            strBody.Append("        </td>")
            strBody.Append("    </tr>")
            strBody.Append("</table>")
            ...
            strBody.Append("        <td align='left'width='400px'>")
            strBody.Append("            Time = ")
            strBody.Append("           " & Left(localTime14, 2) & ":" & Right(localTime14, 2) & " &nbsp;EST ")
            strBody.Append("        </td>")
            strBody.Append("    </tr>")
            strBody.Append("</table>")
    ...
    Private Sub GetWeather(ByVal strIncidentID As String, ByVal strIncidentIncidentTypeID As String)
        ...
        If SubType = "Weather Watch" Or SubType = "Weather Warning" Or SubType = "Weather Advisory" Then
            ...
            If WWAeffectiveDate <> "1/1/1900" Then
            ...
            If WWAexpiresDate <> "1/1/1900" Then
        ...
        ElseIf SubType = "NOAA Transnsmitter Outage" Then
            ...
            If TOserviceOutDate <> "1/1/1900" Then
