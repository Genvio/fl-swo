<%@ Page Language="VB" MasterPageFile="~/LoggedIn.master" AutoEventWireup="false" CodeFile="EditNotificationPosition.aspx.vb" Inherits="EditNotificationPosition" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table width="100%" align="center">
        <tr>
            <td align="center">
                <font size="6">
                    <b><asp:Label ID="lblAddEdit" runat="server" />Position</b>
                </font>
            </td>
        </tr>
    </table>
    ...
    <table width="100%" align="center">
        <tr>
            ...
            <td align="left">
                <asp:TextBox ID="txtPosition" runat="server" Width="500px" />
            </td>
        </tr>
    </table>
    <table width="100%" align="center">
