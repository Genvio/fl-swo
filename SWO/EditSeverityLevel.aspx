<%@ Page Language="VB" MasterPageFile="~/LoggedIn.master" AutoEventWireup="false" CodeFile="EditSeverityLevel.aspx.vb" Inherits="EditSeverityLevel" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table width="100%" align="center">
        <tr>
            <td align="center">
                <font size="6">
                    <b><asp:Label ID="lblAddEdit" runat="server"></asp:Label>Severity Level</b>
                </font>
            </td>
        </tr>
    </table>
    ...
    <table width="100%" align="center">
        <tr>
            <td align="right" width="40%">
                <b><font size="3">Severity Level:</font></b>
            </td>
            <td align="left">
                <asp:TextBox ID="txtSeverityLevel" runat="server" Width="300px" />
            </td>
        </tr>
    </table>
    <table width="100%" align="center">
        <tr>
            ...
            <td align="left">
                <asp:TextBox ID="txtNotes" runat="server" Width="300px" />
            </td>
        </tr>
    </table>
    <table width="100%" align="center">
