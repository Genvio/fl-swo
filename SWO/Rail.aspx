<%@ Page Language="VB" MasterPageFile="~/LoggedIn.master" AutoEventWireup="false" CodeFile="Rail.aspx.vb" Inherits="Rail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        ...
        <tr>
            ...
            <td align="left">
                <asp:DropDownList ID="ddlSubType" style="background-color:#c2ecde" Width="200px"  runat="server">
                    ...
                    <asp:ListItem Value="Rail Accident" Text="Rail Accident"></asp:ListItem>
                    <asp:ListItem Value="Rail Hijacking" Text="Rail Hijacking"></asp:ListItem>
    ...
    <table width="100%" align="center">
        <tr>
            ...
            <td align="left">
                <asp:DropDownList ID="ddlTrainType"   
                    style="background-color:#c2ecde; margin-left: 4px;" Width="175px" runat="server">
                    <asp:ListItem Value="Select an Option" Text="Select an Option" Selected="True"></asp:ListItem>
                    <asp:ListItem Value="Cargo" Text="Cargo"></asp:ListItem>
                    <asp:ListItem Value="Passenger" Text="Passenger"></asp:ListItem>
                    <asp:ListItem Value="Other" Text="Other"></asp:ListItem>
                 </asp:DropDownList>
            </td>
        </tr>
    ...
    <table width="100%" align="center">
        <tr>
            <td align="right" class="style84">
                <big>
                    <b>
                        Name of company operating train:
                    </b>
                </big>
            </td>
            <td align="left">
                <asp:TextBox ID="txtCompanyOperatingTrain" Width="500px" style="background-color:#c2ecde" runat="server"></asp:TextBox>
            </td>
        </tr>
    </table>
    <table width="100%" align="center">
        <tr>
            ...
            <td align="left">
                <asp:TextBox ID="txtTrainNumber" Width="500px" style="background-color:#c2ecde" runat="server"></asp:TextBox>
            </td>
        </tr>
    </table>
    <table width="100%" align="center">
        <tr>
            ...
            <td align="left">
                <asp:TextBox ID="txtRailLiine" Width="500px" style="background-color:#c2ecde" runat="server"></asp:TextBox>
            </td>
        </tr>
    </table>
    <table width="100%" align="center">
        <tr>
            ...
            <td align="left">
                <asp:TextBox ID="txtMilePost" Width="500px" style="background-color:#c2ecde" runat="server"></asp:TextBox>
            </td>
        </tr>
    </table>
    <table width="100%" align="center">
        <tr>
            <td align="right" class="style84">
                <big>
                    <b>
                        DOT crossing number (if applicable):
                    </b>
                </big>
            </td>
            <td align="left">
                <asp:TextBox ID="txtDotCrossingNumber" Width="500px" style="background-color:#c2ecde" runat="server"></asp:TextBox>
            </td>
        </tr>
    </table>
    <table width="100%" align="center">
        <tr>
            <td align="right" class="style84">
                <big>
                    <b>
                        Line owned or operated by:
                    </b>
                </big>
            </td>
            <td align="left">
                <asp:TextBox ID="txtLineOwnedOperatedBy" Width="500px" style="background-color:#c2ecde" runat="server"></asp:TextBox>
            </td>
        </tr>
    </table>
    <table width="100%" align="center">
        <tr>
            ...
            <td align="left">
                <asp:TextBox ID="txtPeopleOnBoard" Width="500px" style="background-color:#c2ecde" runat="server"></asp:TextBox>
            </td>
        </tr>
    </table>
    <table width="100%" align="center">
    ...
    <table width="100%" align="center">
        <tr>
            <td align="right" class="style86">
                <big>
                    <b>
                        Is there a derailment?
                    </b>
                </big>
            </td>
            <td align="left">
                <asp:DropDownList ID="ddlDerailment"   
                    style="background-color:#c2ecde; margin-left: 4px;" Width="175px" runat="server">
                    <asp:ListItem Value="Select an Option" Text="Select an Option" Selected="True"></asp:ListItem>
    ...
    <table width="100%" align="center">
        <tr>
            <td align="right" class="style86">
                <big>
                    <b>
                        Were any hazardous materials released?
                    </b>
                </big>
            </td>
            <td align="left">
                <asp:DropDownList ID="ddlHazMatReleased"   
                    style="background-color:#c2ecde; margin-left: 4px;" Width="175px" runat="server">
                    <asp:ListItem Value="Select an Option" Text="Select an Option" Selected="True"></asp:ListItem>
                    <asp:ListItem Value="Unknown" Text="Unknown"></asp:ListItem>
                    <asp:ListItem Value="Yes" Text="Yes"></asp:ListItem>
