...
Partial Class MilitaryActivity
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Page.IsPostBack = False Then
            ...
            Dim localMilitaryActivityCount As Integer = 0

            objConn.ConnectionString = ConfigurationManager.ConnectionStrings("dbConnectionString").ConnectionString
            objConn.Open()
            objCmd = New SqlCommand("spSelectMilitaryActivityCountByIncidentID", objConn)
            ...
            If objDR.Read() Then
                ...
                localMilitaryActivityCount = HelpFunction.ConvertdbnullsInt(objDR("Count"))
            ...
            If localMilitaryActivityCount > 0 Then
                PopulatePage()
            End If
    ...
    Protected Sub PopulatePage()
        ...
        objConn.ConnectionString = ConfigurationManager.ConnectionStrings("dbConnectionString").ConnectionString
        objConn.Open()
        objCmd = New SqlCommand("spSelectMilitaryActivityByIncidentID", objConn)
        objCmd.CommandType = CommandType.StoredProcedure
        objCmd.Parameters.AddWithValue("@IncidentID", Request("IncidentID"))
        objCmd.Parameters.AddWithValue("@IncidentIncidentTypeID", Request("IncidentIncidentTypeID"))
        ...
        If objDR.Read() Then
            ...
            ddlReportType.SelectedValue = HelpFunction.Convertdbnulls(objDR("ReportType"))
            txtLaunchDate.Text = HelpFunction.Convertdbnulls(objDR("LaunchDate"))
            localTime = CStr(HelpFunction.Convertdbnulls(objDR("LaunchTime")))
            txtLaunchMessage.Text = HelpFunction.Convertdbnulls(objDR("LaunchMessage"))
            ddlFlightPath.SelectedValue = HelpFunction.Convertdbnulls(objDR("FlightPath"))
            txtUnitConductingActivity.Text = HelpFunction.Convertdbnulls(objDR("UnitConductingActivity"))
            txtActivityDescription.Text = HelpFunction.Convertdbnulls(objDR("ActivityDescription"))
            txtActivityTimeDateRange.Text = HelpFunction.Convertdbnulls(objDR("ActivityTimeDateRange"))
            txtAirspaceRestrictions.Text = HelpFunction.Convertdbnulls(objDR("AirspaceRestrictions"))
            txtRoadClosures.Text = HelpFunction.Convertdbnulls(objDR("RoadClosures"))
            txtContactName.Text = HelpFunction.Convertdbnulls(objDR("ContactName"))
            txtContactNumber.Text = HelpFunction.Convertdbnulls(objDR("ContactNumber"))
        ...
        txtLaunchTime.Text = Left(localTime, 2)
        txtLaunchTime2.Text = Right(localTime, 2)

        If txtLaunchTime.Text = "0" Then
            txtLaunchTime.Text = ""
        End If

        If txtLaunchTime2.Text = "0" Then
            txtLaunchTime2.Text = ""
        End If

        If txtLaunchDate.Text = "1/1/1900" Then
            txtLaunchDate.Text = ""
        End If
        ...
        If ddlSubType.SelectedValue = "Tomahawk Missile Launch" Then
            pnlShowTomahawk.Visible = True
        Else
    ...
    Protected Sub Save()
        ...
        If pnlShowTomahawk.Visible = False Then
            ddlReportType.SelectedValue = "Select an Option"
            txtLaunchDate.Text = ""
            txtLaunchTime.Text = ""
            txtLaunchTime2.Text = ""
            ddlFlightPath.SelectedValue = "Select an Option"
        Else
            txtUnitConductingActivity.Text = ""
            txtActivityDescription.Text = ""
            txtActivityTimeDateRange.Text = ""
            txtAirspaceRestrictions.Text = ""
            txtRoadClosures.Text = ""
            txtContactName.Text = ""
        ...
        If localMilitaryActivityCount = 0 Then
            ...
            objCmd = New SqlCommand("spActionMilitaryActivity", objConn)
            objCmd.CommandType = CommandType.StoredProcedure
            objCmd.Parameters.AddWithValue("@IncidentID", Request("IncidentID"))
            objCmd.Parameters.AddWithValue("@IncidentIncidentTypeID", Request("IncidentIncidentTypeID"))
            ...
            objCmd.Parameters.AddWithValue("@ReportType", ddlReportType.SelectedValue.ToString)
            objCmd.Parameters.AddWithValue("@LaunchDate", txtLaunchDate.Text)
            objCmd.Parameters.AddWithValue("@LaunchTime", CStr(txtLaunchTime.Text.Trim) & CStr(txtLaunchTime2.Text.Trim))
            objCmd.Parameters.AddWithValue("@LaunchMessage", txtLaunchMessage.Text)
            objCmd.Parameters.AddWithValue("@FlightPath", ddlFlightPath.SelectedValue.ToString)
            objCmd.Parameters.AddWithValue("@UnitConductingActivity", txtUnitConductingActivity.Text)
            objCmd.Parameters.AddWithValue("@ActivityDescription", txtActivityDescription.Text)
            objCmd.Parameters.AddWithValue("@ActivityTimeDateRange", txtActivityTimeDateRange.Text)
            objCmd.Parameters.AddWithValue("@AirspaceRestrictions", txtAirspaceRestrictions.Text)
            objCmd.Parameters.AddWithValue("@RoadClosures", txtRoadClosures.Text)
            objCmd.Parameters.AddWithValue("@ContactName", txtContactName.Text)
            objCmd.Parameters.AddWithValue("@ContactNumber", txtContactNumber.Text)
            ...
            Try
                ...
                objCmd.Parameters.AddWithValue("@MostRecentUpdate", "Added Military Activity")
        ...
        Else
            ...
            Try
                ...
                objCmd.Parameters.AddWithValue("@UpdateDate", NowDate)
                objCmd.Parameters.AddWithValue("@UserID", ns.UserID) 'oCookie.Item("UserID"))
                objCmd.Parameters.AddWithValue("@MostRecentUpdate", "Updated Military Activity")
