...
Partial Class IncidentNonAdmin
    ...
    Sub getIncident(ByVal sSortStr As String, ByVal sSearchBy As String, ByVal sSearchText As String)
        ...
        strIncidentTypeID = MrDataGrabber.GrabIncidentTypeUserByUserID(CStr(ns.UserID))
        ...
        If strIncidentTypeID <> "" Then
            ...
            objCmd = New SqlCommand("spFilterIncidentNonAdmin2", objConn)
    ...
    Sub SortIncident(ByVal sender As Object, ByVal e As DataGridSortCommandEventArgs)
        ...
        'Sort the data in new order. Seacrhes by provided.
    ...
    Sub PopulateDDLs()
        ...
        ddlIncidentType.Items.Insert(0, New ListItem("All Worksheets", "0"))

        'Temporary fix below..
        '--------------------------------------------------------------------------------------------------------
        'ddlIncidentType.Items.Insert(8, New ListItem("Environmental Crime", "8"))
        '--------------------------------------------------------------------------------------------------------
