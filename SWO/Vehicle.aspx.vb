...
Partial Class Vehicle
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Page.IsPostBack = False Then
            ...
            Dim localVehicleCount As Integer = 0

            objConn.ConnectionString = ConfigurationManager.ConnectionStrings("dbConnectionString").ConnectionString
            objConn.Open()
            objCmd = New SqlCommand("spSelectVehicleCountByIncidentID", objConn)
            ...
            If objDR.Read() Then
                ...
                localVehicleCount = HelpFunction.ConvertdbnullsInt(objDR("Count"))
    ...
    Protected Sub PopulatePage()
        ...
        objConn.ConnectionString = ConfigurationManager.ConnectionStrings("dbConnectionString").ConnectionString
        objConn.Open()
        objCmd = New SqlCommand("spSelectVehicleByIncidentID", objConn)
        objCmd.CommandType = CommandType.StoredProcedure
        objCmd.Parameters.AddWithValue("@IncidentID", Request("IncidentID"))
        objCmd.Parameters.AddWithValue("@IncidentIncidentTypeID", Request("IncidentIncidentTypeID"))
        ...
        If objDR.Read() Then
            ...
            txtVehiclesInvolvedNumber.Text = HelpFunction.Convertdbnulls(objDR("VehiclesInvolvedNumber"))
            txtVehicleType.Text = HelpFunction.Convertdbnulls(objDR("VehicleType"))
            txtPeopleInvolvedNumber.Text = HelpFunction.Convertdbnulls(objDR("PeopleInvolvedNumber"))
            txtCommercialCarrierOwnedOperatedBy.Text = HelpFunction.Convertdbnulls(objDR("CommercialCarrierOwnedOperatedBy"))
    ...
    Protected Sub Save()
        ...
        If localVehicleCount = 0 Then
            ...
            objCmd = New SqlCommand("spActionVehicle", objConn)
            objCmd.CommandType = CommandType.StoredProcedure
            objCmd.Parameters.AddWithValue("@IncidentID", Request("IncidentID"))
            objCmd.Parameters.AddWithValue("@IncidentIncidentTypeID", Request("IncidentIncidentTypeID"))
            ...
            objCmd.Parameters.AddWithValue("@VehiclesInvolvedNumber", txtVehiclesInvolvedNumber.Text)
            objCmd.Parameters.AddWithValue("@VehicleType", txtVehicleType.Text)
            objCmd.Parameters.AddWithValue("@PeopleInvolvedNumber", txtPeopleInvolvedNumber.Text)
            objCmd.Parameters.AddWithValue("@CommercialCarrierOwnedOperatedBy", txtCommercialCarrierOwnedOperatedBy.Text)
            ...
            Try
                ...
                objCmd.Parameters.AddWithValue("@MostRecentUpdate", "Added Vehicle Incident")
        ...
        Else
            ...
            Try
                ...
                objCmd.Parameters.AddWithValue("@UpdateDate", NowDate)
                objCmd.Parameters.AddWithValue("@UserID", ns.UserID) 'oCookie.Item("UserID"))
                objCmd.Parameters.AddWithValue("@MostRecentUpdate", "Updated Vehicle Incident")
