...
Public Class BlackBerryReport
    ...
    Public Sub New(ByVal strIncidentID As String, Optional ByVal strInstantiator As String = "Unknown")
        ...
        If gStrIsThisADrill = "Yes" Then
            ...
            strBody.Append("    <tr>")
            strBody.Append("        <td  width='400px' align='left' style='background-color:#ff0000; color:#000000;' >")
        ...
        strBody.Append("    </tr>")
        strBody.Append("    <tr>")
        strBody.Append("        <td width='400px' align='left'>")
    ...
    Protected Sub GetNotifications()
        ...
        If objDR.HasRows Then
            'Just get the lastest notification and ignore the others (sp orders by PK DESC, so first record returned is most recent)
            'While objDR.Read
            objDR.Read()
            ...
            strNotifications.Append("<table width='400px'cellspacing='0' border='0'>")
            strNotifications.Append("    <tr>")
            strNotifications.Append("        <td width='400px' align='left' style='background-color:#d4d4d4; color:#000000;' >")
            ...
            strNotifications.Append("<table>")
            strNotifications.Append("    <tr>")
            strNotifications.Append("        <td align='left'width='400px'>")
    ...
    Protected Sub GetUpdates()
        ...
        objCmd = New SqlCommand("[spSelectUpdateReportNotificationByIncidentID]", objConn)
        objCmd.Parameters.AddWithValue("@IncidentID", gStrIncidentID)
        ...
        If objDR.HasRows Then
            While objDR.Read
                ...
                strUpdate.Append("<table>")
                strUpdate.Append("    <tr>")
                strUpdate.Append("        <td align='left'width='400px'>")
    ...
    Protected Sub GetMainForm()
        ...
        strBody.Append("    <tr>")
        strBody.Append("        <td align='left'width='400px'>")
        strBody.Append("            <b>Florida Division of Emergency Management</b>")
        strBody.Append("        </td>")
        strBody.Append("    </tr>")
        strBody.Append("    <tr>")
        strBody.Append("        <td align='left'width='400px'>")
        strBody.Append("            <b>State Watch Office Incident Report</b>")
        strBody.Append("        </td>")
        strBody.Append("    </tr>")
        strBody.Append("</table>")
        ...
        If localRecordAccountForArray <> 0 Then
            'Must subtract 1 from the account for the array declaration.
            Dim arrIncidentType(localRecordAccountForArray - 1) As Integer

            'Store each IncidentTypeID in the array.
            'Check to see if there are any worksheets that are exempt.
            objConn.ConnectionString = ConfigurationManager.ConnectionStrings("dbConnectionString").ConnectionString
        ...
        If IsExempt = True Then
            strBody.Append("<table>")
            strBody.Append("    <tr>")
            strBody.Append("        <td  width='400px' align='left' style='background-color:#c2ecde; color:#000000;' >")
            ...
            strBody.Append("<table>")
            strBody.Append("    <tr>")
            strBody.Append("        <td align='left' width='400px' style='background-color:White; height:25px; color:#ff0000; font:Arial; font-size:1.1em;'> ")
        ...
        If objDS.Tables(0).Rows.Count <> 0 Then
            ...
            For Each objAgency As DataRow In objDS.Tables(0).Rows
                strAgencyContacts = strAgencyContacts & objAgency.Item(2).ToString & " / "
            Next

            strAgencyContacts = strAgencyContacts.Substring(0, strAgencyContacts.Length - 3)
        ...
        If localStateWide = False Then
            ...
            If localRegion2 Then
                strCountiesInRegions = strCountiesInRegions & oCountyRegions.GetCountiesByRegion(2) & ", "
        ...
        If localLat <> 0 And localLong <> 0 Then
            strBody.Append("<a href='https://floridadisaster.maps.arcgis.com/apps/webappviewer/index.html?id=74f3e78117fd44b28ffec5adc30c6024&scale=2000&marker=" & localLong & "," & localLat & "' target='blank'><img src='https://apps.floridadisaster.org/swo/Images/Maplcon.jpg' height='50' width='50'/></a>")


            'strBody.Append("<table width='100%'cellspacing='0' border='0'>")
            'strBody.Append("    <tr>")
            'strBody.Append("        <td align='left'width='400px'>")
            'strBody.Append("            <img id='imgMap1' alt='Map1' width='400px' src='http://maps.googleapis.com/maps/api/staticmap?center=" & localLat & "," & localLong & "&markers=size:mid|color:red|" & localLat & "," & localLong & "&zoom=7&size=321x250&maptype=street&format=jpg&key=ABQIAAAAaa6B5ZMUVanPrZJU5dhtshRzymbT3klSnJpNv7EI1uNYq_UBqhTmwXd4YDorUwqRsabizyja-ZgPoQ' />" & " ")
            'strBody.Append("        </td>")
            'strBody.Append("    </tr>")
            'strBody.Append("    <tr>")
            'strBody.Append("        <td align='left'width='400px'>")
            'strBody.Append("            <img id='imgMap2' alt='Map2' width='400px' src='http://maps.googleapis.com/maps/api/staticmap?center=" & localLat & "," & localLong & "&markers=size:mid|color:red|" & localLat & "," & localLong & "&zoom=14&size=321x250&maptype=street&format=jpg&key=ABQIAAAAaa6B5ZMUVanPrZJU5dhtshRzymbT3klSnJpNv7EI1uNYq_UBqhTmwXd4YDorUwqRsabizyja-ZgPoQ' />" & " ")
            'strBody.Append("        </td>")
            'strBody.Append("    </tr>")
            'strBody.Append("</table>")
        End If
    ...
    Private Sub GetHazardousMaterials(ByVal strIncidentID As String, ByVal strIncidentIncidentTypeID As String)
        ...
        ElseIf SubType = "Toxic Industrial Chemical" Then
            ...
            If ChemicalQuantityReleased <> "" Then
                strBody.Append("<table>")
                strBody.Append("    <tr>")
                strBody.Append("        <td align='left'width='400px'>")
                strBody.Append("            <b>Quantity released:</b> ")
                strBody.Append("           " & ChemicalQuantityReleased & "  ")
                strBody.Append("        </td>")
                strBody.Append("    </tr>")
                strBody.Append("</table>")
            End If
    ...
    Private Sub GetNPP(ByVal strIncidentID As String, ByVal strIncidentIncidentTypeID As String)
        ...
        'New NPP fields as of 12/18/2018
        Dim Papa1 As String = ""
        Dim Papa2 As String = ""
        Dim Papa3 As String = ""
        ...
        Dim OneMileTEDE As String = ""
        Dim OneMileCDE As String = ""
        Dim TwoMileTEDE As String = ""
        Dim TwoMileCDE As String = ""
        Dim FiveMileTEDE As String = ""
        Dim FiveMileCDE As String = ""
        Dim TenMileTEDE As String = ""
        Dim TenMileCDE As String = ""
        ...
        Dim SiteLucie1 = "", SiteLucie2 = "", SiteTurkey1 = "", SiteTurkey2 = ""
        ...
        If objDR2.Read() Then
            ...
            'New NPP Fields
            Papa1 = HelpFunction.Convertdbnulls(objDR2("Papa1"))
            Papa2 = HelpFunction.Convertdbnulls(objDR2("Papa2"))
            Papa3 = HelpFunction.Convertdbnulls(objDR2("Papa3"))
            Delta1 = HelpFunction.Convertdbnulls(objDR2("Delta1"))
            Delta2 = HelpFunction.Convertdbnulls(objDR2("Delta2"))
            Delta3 = HelpFunction.Convertdbnulls(objDR2("Delta3"))
            Potassium = HelpFunction.Convertdbnulls(objDR2("Potassium"))
            VerificationStateWatchOffice = HelpFunction.Convertdbnulls(objDR2("VerificationStateWatchOffice"))
            VerificationDOH = HelpFunction.Convertdbnulls(objDR2("VerificationDOH"))
            VerificationStLucie = HelpFunction.Convertdbnulls(objDR2("VerificationStLucie"))
            VerificationMartinCo = HelpFunction.Convertdbnulls(objDR2("VerificationMartinCo"))
            VerificationMiamiDade = HelpFunction.Convertdbnulls(objDR2("VerificationMiamiDade"))
            VerificationMonroeCo = HelpFunction.Convertdbnulls(objDR2("VerificationMonroeCo"))
            OneMileTEDE = HelpFunction.Convertdbnulls(objDR2("OneMileTEDE"))
            OneMileCDE = HelpFunction.Convertdbnulls(objDR2("OneMileCDE"))
            TwoMileTEDE = HelpFunction.Convertdbnulls(objDR2("TwoMileTEDE"))
            TwoMileCDE = HelpFunction.Convertdbnulls(objDR2("TwoMileTEDE"))
            FiveMileTEDE = HelpFunction.Convertdbnulls(objDR2("FiveMileTEDE"))
            FiveMileCDE = HelpFunction.Convertdbnulls(objDR2("FiveMileCDE"))
            TenMileTEDE = HelpFunction.Convertdbnulls(objDR2("TenMileTEDE"))
            TenMileCDE = HelpFunction.Convertdbnulls(objDR2("TenMileCDE"))
            ...
            SiteLucie1 = HelpFunction.Convertdbnulls(objDR2("SiteLucie1"))
            SiteLucie2 = HelpFunction.Convertdbnulls(objDR2("SiteLucie2"))
            SiteTurkey1 = HelpFunction.Convertdbnulls(objDR2("SiteTurkey1"))
            SiteTurkey2 = HelpFunction.Convertdbnulls(objDR2("SiteTurkey2"))
            ...
            ShowPlantConditions = HelpFunction.Convertdbnulls(objDR2("ShowPlantConditions"))
        ...
        If SubType = "Crystal River – Full ENF" Or SubType = "Saint Lucie" Or SubType = "Turkey Point" Then
            ...
            If CSTselectOne <> "" And CSTselectOne <> "Select an Option" Then
                ...
                strBody.Append("    <tr>")
                strBody.Append("        <td align='left'width='400px'>")
                strBody.Append("           <b> 1. " & CSTselectOne & " </b> ")
                strBody.Append("        </td>")
                strBody.Append("    </tr>")
                strBody.Append("</table>")
            End If
            ...
            strBody.Append("    <tr>")
            strBody.Append("        <td align='left'width='400px'>")
            strBody.Append("            <b>3. Verified By:</b> ")
            If VerificationStateWatchOffice = "1" Then
                strBody.Append("            State Watch Office &nbsp;")
            End If
            If VerificationDOH = "1" Then
                strBody.Append("           DOH/BRC &nbsp;")
            End If
            If VerificationStLucie = "1" Then
                strBody.Append("           St. Lucie Co. &nbsp;")
            End If
            If VerificationMartinCo = "1" Then
                strBody.Append("           Martin Co. &nbsp;")
            End If
            If VerificationMiamiDade = "1" Then
                strBody.Append("           Miami-Dade Co. &nbsp;")
            End If
            If VerificationMonroeCo = "1" Then
                strBody.Append("           Monroe Co. &nbsp;")
            End If
            strBody.Append("        </td>")
            strBody.Append("    </tr>")
            strBody.Append("</table>")
            ...
            If CSTmessageNumber <> "" Then
                ...
                strBody.Append("    <tr>")
                strBody.Append("        <td align='left'width='400px'>")
                strBody.Append("            <b>4. Message Number:</b> ")
            ...
            If CSTsite <> "" Or (SiteLucie1 = "1" Or SiteLucie2 = "1" Or SiteTurkey1 = "1" Or SiteTurkey2 = "1") Then
                Dim sites = ""
                If CSTsite <> "" Then
                    sites = sites + " " + CSTsite
                End If
                If SiteLucie1 = "1" Then
                    sites = sites + " St. Lucie Unit 1"
                End If
                If SiteLucie2 = "1" Then
                    sites = sites + " St Lucie Unit 2"
                End If
                If SiteTurkey1 = "1" Then
                    sites = sites + " Turkey Point Unit 3"
                End If
                If SiteTurkey2 = "1" Then
                    sites = sites + " Turkey Point Unit 4"
                End If

                strBody.Append("<table>")
                strBody.Append("    <tr>")
                strBody.Append("        <td align='left'width='400px'>")
                strBody.Append("            <b>5. Affected Site:</b> ")
                strBody.Append("           " & sites & "  ")
                strBody.Append("        </td>")
                strBody.Append("    </tr>")
                strBody.Append("</table>")
            End If
            ...
            If CSTemergencyClassification <> "" And CSTemergencyClassification <> "Select an Option" Then
                ...
                strBody.Append("    <tr>")
                strBody.Append("        <td align='left'width='400px'>")
                strBody.Append("            <b>6. Emergency Classification:</b> ")
            ...
            If CSTdecTermSelectOne <> "" Then
                strBody.Append("<table>")
                strBody.Append("    <tr>")
                strBody.Append("        <td align='left'width='400px'>")
                strBody.Append("            <b>7. Emergency Declartion/ Emergency Termination:</b> ")
            ...
            If CST15Date <> "" And CSTdecTermDate <> "1/1/1900" Then
                strBody.Append("<table>")
                strBody.Append("    <tr>")
                strBody.Append("        <td align='left'width='400px'>")
                strBody.Append("            <b>7. Date:</b> ")
            ...
            If CSTeALDescription <> "" Then
                ...
                strBody.Append("    <tr>")
                strBody.Append("        <td align='left'width='400px'>")
                strBody.Append("            <b>8. Reason for Emergency Declaration:</b> ")
                If CSTeALNumbers <> "" Then
                    strBody.Append("          A. EAL Number: " & CSTeALNumbers & "  ")
                End If
                If CSTeALNumbers <> "" Then
                    strBody.Append("          B. Description: " & CSTeALDescription & "  ")
                End If
                strBody.Append("        </td>")
                strBody.Append("    </tr>")
                strBody.Append("</table>")
            ...
            If CSTwindDirectionDegrees <> "" Then
                ...
                strBody.Append("    <tr>")
                strBody.Append("        <td align='left'width='400px'>")
                strBody.Append("            <b>9. Weather Data &nbsp; A. Wind direction from degrees:</b> ")
            ...
            If CSTdownwindSectorsAffected <> "" Then
                ...
                strBody.Append("    <tr>")
                strBody.Append("        <td align='left'width='400px'>")
                strBody.Append("            <b>9. B. Downwind Sectors Affected:</b> ")
            ...
            If CSTreleaseStatus <> "" And CSTreleaseStatus <> "Select an Option" Then
                ...
                strBody.Append("    <tr>")
                strBody.Append("        <td align='left'width='400px'>")
                strBody.Append("            <b>10. Release Status:</b> ")
            ...
            If CSTutilRecProtAct <> "A. No utility recommended actions at this time." Then
                ...
                If Papa1 = "1" Then
                    ...
                    strBody.Append("    <tr>")
                    strBody.Append("        <td align='left'width='400px'>")
                    strBody.Append("            <b>Papa 1:</b> ")
                    strBody.Append("           <table border='1'><tr><td style='font-size:  9px'>Miles</td><td style='font-size 9px'>Evacuation Sectors</td><td style='font-size 9px'>Shelter Sectors</td><td style='font-size 9px'>Monitor & Prepare Sectors</td></tr><tr><td style='font-size 9px'>0-2</td><td style='font-size 9px'>All</td><td style='font-size 9px'>None</td><td style='font-size 9px'>None</td></tr><tr><td style='font-size 9px'>2-5</td><td style='font-size 9px'>Downwind</td>  <td style='font-size 9px'>None</td><td style='font-size 9px'>None</td> </tr> <tr> <td style='font-size 9px'>5-10</td> <td style='font-size 9px'>None</td> <td style='font-size 9px'>None</td> <td style='font-size 9px'>All</td> </tr></table>")
                    strBody.Append("        </td>")
                    strBody.Append("    </tr>")
                    strBody.Append("</table>")
                End If
                ...
                If Papa2 = "1" Then
                    ...
                    strBody.Append("    <tr>")
                    strBody.Append("        <td align='left'width='400px'>")
                    strBody.Append("            <b>Papa 2:</b> ")
                    strBody.Append("           <table border='1'><tr><td style='font-size:  9px'>Miles</td><td style='font-size 9px'>Evacuation Sectors</td><td style='font-size 9px'>Shelter Sectors</td><td style='font-size 9px'>Monitor & Prepare Sectors</td></tr><tr><td style='font-size 9px'>0-2</td><td style='font-size 9px'>None</td><td style='font-size 9px'>All</td><td style='font-size 9px'>None</td></tr><tr><td style='font-size 9px'>2-5</td><td style='font-size 9px'>None</td><td style='font-size 9px'>Downwind</td><td style='font-size 9px'>All Remaining</td></tr><tr><td style='font-size 9px'>5-10</td><td style='font-size 9px'>None</td><td style='font-size 9px'>None</td><td style='font-size 9px'>All</td></tr></table>")
                    strBody.Append("        </td>")
                    strBody.Append("    </tr>")
                    strBody.Append("</table>")
                End If
                ...
                If Papa3 = "1" Then
                    ...
                    strBody.Append("    <tr>")
                    strBody.Append("        <td align='left'width='400px'>")
                    strBody.Append("            <b>Papa 3:</b> ")
                    strBody.Append("           <table border='1'><tr><td style='font-size:  9px'>Miles</td><td style='font-size 9px'>Evacuation Sectors</td><td style='font-size 9px'>Shelter Sectors</td><td style='font-size 9px'>Monitor & Prepare Sectors</td></tr><tr><td style='font-size 9px'>0-2</td><td style='font-size 9px'>All</td><td style='font-size 9px'>None</td><td style='font-size 9px'>None</td></tr><tr><td style='font-size 9px'>2-5</td><td style='font-size 9px'>Downwind</td><td style='font-size 9px'>None</td><td style='font-size 9px'>All Remaining</td></tr><tr><td style='font-size 9px'>5-10</td><td style='font-size 9px'>None</td><td style='font-size 9px'>Downwind</td><td style='font-size 9px'>All Remaining</td></tr></table>  ")
                    strBody.Append("        </td>")
                    strBody.Append("    </tr>")
                    strBody.Append("</table>")
                End If
                ...
                If Delta1 = "1" Then
                    ...
                    strBody.Append("    <tr>")
                    strBody.Append("        <td align='left'width='400px'>")
                    strBody.Append("            <b>Delta 1:</b> ")
                    strBody.Append("             <table border='1'><tr><td style='font-size:  9px'>Miles</td><td style='font-size 9px'>Evacuation Sectors</td><td style='font-size 9px'>Shelter Sectors</td><td style='font-size 9px'>Monitor & Prepare Sectors</td></tr><tr><td style='font-size 9px'>0-2</td><td style='font-size 9px'>All</td><td style='font-size 9px'>None</td><td style='font-size 9px'>None</td></tr><tr><td style='font-size 9px'>2-5</td><td style='font-size 9px'>Downwind</td><td style='font-size 9px'>None</td><td style='font-size 9px'>All Remaining</td></tr> <tr><td style='font-size 9px'>5-10</td> <td style='font-size 9px'>None</td> <td style='font-size 9px'>None</td> <td style='font-size 9px'>All</td> </tr> </table> ")
                    strBody.Append("        </td>")
                    strBody.Append("    </tr>")
                    strBody.Append("</table>")
                End If
                ...
                If Delta2 = "1" Then
                    ...
                    strBody.Append("    <tr>")
                    strBody.Append("        <td align='left'width='400px'>")
                    strBody.Append("            <b>Delta 2:</b> ")
                    strBody.Append("            <table border='1'><tr><td style='font-size:  9px'>Miles</td><td style='font-size 9px'>Evacuation Sectors</td><td style='font-size 9px'>Shelter Sectors</td><td style='font-size 9px'>Monitor & Prepare Sectors</td></tr><tr><td style='font-size 9px'>0-2</td><td style='font-size 9px'>All</td> <td style='font-size 9px'>None</td><td style='font-size 9px'>None</td></tr> <tr><td style='font-size 9px'>2-5</td><td style='font-size 9px'>Downwind</td><td style='font-size 9px'>None</td><td style='font-size 9px'>All Remaining</td></tr><tr><td style='font-size 9px'>5-10</td><td style='font-size 9px'>Downwind</td><td style='font-size 9px'>None</td><td style='font-size 9px'>All Remaining</td></tr></table>  ")
                    strBody.Append("        </td>")
                    strBody.Append("    </tr>")
                    strBody.Append("</table>")
                End If
                ...
                If Delta3 = "1" Then
                    ...
                    strBody.Append("    <tr>")
                    strBody.Append("        <td align='left'width='400px'>")
                    strBody.Append("            <b>Delta 3:</b> ")
                    strBody.Append("          <table border='1'> <tr><td style='font-size:  9px'>Miles</td><td style='font-size 9px'>Evacuation Sectors</td><td style='font-size 9px'>Shelter Sectors</td><td style='font-size 9px'>Monitor & Prepare Sectors</td></tr><tr><td style='font-size 9px'>0-2</td><td style='font-size 9px'>All</td><td style='font-size 9px'>None</td><td style='font-size 9px'>None</td></tr><tr><td style='font-size 9px'>2-5</td><td style='font-size 9px'>Downwind</td><td style='font-size 9px'>None</td><td style='font-size 9px'>All Remaining</td></tr><tr><td style='font-size 9px'>5-10</td><td style='font-size 9px'>Downwind</td><td style='font-size 9px'>None</td><td style='font-size 9px'>All Remaining</td></tr><tr><td style='font-size 9px'>>10</td><td style='font-size 9px'>Downwind</td><td style='font-size 9px'>None</td><td style='font-size 9px'>All Remaining</td></tr></table>  ")
                    strBody.Append("        </td>")
                    strBody.Append("    </tr>")
                    strBody.Append("</table>")
                End If
                ...
                If Potassium = "1" Then
                    ...
                    strBody.Append("    <tr>")
                    strBody.Append("        <td align='left'width='400px'>")
                    strBody.Append("            <b>Potassium:</b> ")
                    strBody.Append("           Consider issuance of potassium iodide(KI) ")
                    strBody.Append("        </td>")
                    strBody.Append("    </tr>")
                    strBody.Append("</table>")
                End If
            ...
            If CSTreportedFrom <> "Control Room" Then
                ...
                If CST13A <> "" Then
                    ...
                    If CSTsigCatSiteBoundary <> "" And CSTsigCatSiteBoundary <> "Select an Option" Then
                        ...
                        strBody.Append("    <tr>")
                        strBody.Append("        <td align='left'width='400px'>")
                        strBody.Append("            <b>14. Release Significance at Site Boundary:</b> ")
                    ...
                    If CSTeALai = "A. None" Then
                        strBody.Append("<table>")
                        strBody.Append("    <tr>")
                        strBody.Append("        <td align='left'width='400px'>")
                    strBody.Append("            <b>15 A. Not Applicable:</b> ")
                    ...
                    Else
                        ...
                        strBody.Append("    <tr>")
                        strBody.Append("        <td align='left'width='400px'>")
                        strBody.Append("            <b>15. Dose Projection:</b> ")
                        strBody.Append("           " & CST14A & "  ")
                        strBody.Append("        </td>")
                        strBody.Append("    </tr>")
                        strBody.Append("</table>")
                        If OneMileCDE = "" And OneMileTEDE = "" Then
                            'Show Nothing
                        Else
                            strBody.Append("<table>")
                            strBody.Append("    <tr>")
                            ...
                            If OneMileTEDE <> "" Then
                                strBody.Append("       <b>A. </b> Projected Total Dose (TEDE) for  " & OneMileTEDE & " mrem ")
                            End If

                            If OneMileCDE <> "" Then
                                strBody.Append("          <b>E. </b>   Projected Thyroid Dose (CDE) for  " & OneMileCDE & " mrem &nbsp;")
                            End If
                        ...
                        If TwoMileCDE = "" And TwoMileTEDE = "" Then
                            'Show Nothing
                        Else
                            strBody.Append("<table>")
                            strBody.Append("    <tr>")
                            strBody.Append("        <td align='left'width='400px'>")
                            strBody.Append("            <b>2 Mile (Site Boundary):</b> ")


                            If TwoMileTEDE <> "" Then
                                strBody.Append("       <b>B. </b>    Projected Total Dose (TEDE) for  " & TwoMileTEDE & " mrem ")
                            End If

                            If TwoMileCDE <> "" Then
                                strBody.Append("         <b>F. </b>    Projected Thyroid Dose (CDE) for  " & TwoMileCDE & " mrem &nbsp;")
                            End If
                        ...
                        If FiveMileCDE = "" And FiveMileTEDE = "" Then
                            'Show Nothing
                        Else
                            strBody.Append("<table>")
                            strBody.Append("    <tr>")
                            strBody.Append("        <td align='left'width='400px'>")
                            strBody.Append("            <b>5 Mile (Site Boundary):</b> ")

                            If FiveMileTEDE <> "" Then
                                strBody.Append("        <b>C. </b>   Projected Total Dose (TEDE) for  " & FiveMileTEDE & " mrem ")
                            End If

                            If FiveMileCDE <> "" Then
                                strBody.Append("           <b>G. </b>  Projected Thyroid Dose (CDE) for  " & FiveMileCDE & " mrem &nbsp;")
                            End If
                        ...
                        If TenMileCDE = "" And TenMileTEDE = "" Then
                            'Show Nothing
                        Else
                            strBody.Append("<table>")
                            strBody.Append("    <tr>")
                            strBody.Append("        <td align='left'width='400px'>")
                            strBody.Append("            <b>10 Mile (Site Boundary):</b> ")

                            If TenMileTEDE <> "" Then
                                strBody.Append("        <b>D. </b>    Projected Total Dose (TEDE) for  " & TenMileTEDE & " mrem ")
                            End If

                            If TenMileCDE <> "" Then
                                strBody.Append("            <b>H. </b>  Projected Thyroid Dose (CDE) for  " & TenMileCDE & " mrem &nbsp;")
                            End If
                ...
                strBody.Append("    <tr>")
                strBody.Append("        <td align='left'width='400px'>")
                strBody.Append("            <b>16. Message Received By:(Name):</b> ")
    ...
    Private Sub GetWeatherAdvisories(ByVal strIncidentID As String, ByVal strIncidentIncidentTypeID As String)
        ...
        If objDR2.HasRows = True Then
            Do While objDR2.Read()
                ...
                strBody.Append("    <tr>")
                strBody.Append("        <td align='left'width='400px'>")
                strBody.Append("            <img id='Map' alt='Map" & WeatherMapName & "' width='400px' src='https://apps.floridadisaster.org/" & HttpContext.Current.Application("ApplicationEnvironmentForUpload").ToString & "/Uploads/" & WeatherMap & "'>")
                strBody.Append("        </td>")
                strBody.Append("    </tr>")
                strBody.Append("</table>")
            Loop
