<%@ Page Language="VB" MasterPageFile="~/LoggedIn.master" AutoEventWireup="false" CodeFile="ArchiveNonAdmin.aspx.vb" Inherits="ArchiveNonAdmin" %>
            ...
            <table width="100%" align="center">
                <tr>
                    <td align="center">
                        ...
                        &nbsp;
                        <asp:TextBox runat="server" ID="txtSearch"></asp:TextBox>&nbsp;&nbsp;<asp:Button ID="btnSearch" Text="Search" runat="server" />
                        &nbsp;Filter By Worksheet Type:
                        <asp:DropDownList ID="ddlIncidentType" Width="200px" DataTextField="IncidentType" DataValueField="IncidentTypeID" runat="server" AutoPostBack="true"></asp:DropDownList>
                        &nbsp;
                ...
                <tr>
                    <td>
                       <asp:DataGrid  ID="IncidentDataGrid" runat="server" Width="100%" PageSize="30"
                            OnSortCommand="SortIncident" AutoGenerateColumns="false" AllowSorting="True" AllowPaging="true"  PagerStyle-HorizontalAlign="center"
                            ...
                            <Columns>
                                ...
                                <asp:HyperLinkColumn Visible="False" Target="_parent" DataNavigateUrlField="IncidentId"
                                    DataTextField="IncidentID" SortExpression="IncidentID ASC" HeaderText="IncidentID">
                                    <HeaderStyle Wrap="False"></HeaderStyle>
                                </asp:HyperLinkColumn>
                              
                                <asp:BoundColumn ItemStyle-HorizontalAlign="Center" DataField="IncidentNumber" SortExpression="IncidentID DESC" HeaderText="Incident # <img src='Images/blue_arrow_UP2.jpg' align='absmiddle' border=0>">
