...
Partial Class ViewIntialChanges
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Page.IsPostBack = False Then
            ...
            strBody.Append(" <font size='5'><big><b>Initial Report Log</b></big></font> ")
            strBody.Append("</td>")
            ...
            If objDR.Read() Then
                ...
                strBody.Append("<tr>")
                strBody.Append("<td align='center' style='border-color:#000000;' ><font size='5'><b>Initial Report</b></font></td>")
                ...
                While objDR.Read
                    ...
                    strBody.Append("<tr>")
                    strBody.Append("<td align='left' style='border-color:#000000;' ><font size='5'>" & objDR.Item("InitialReport") & "</font></td>")
