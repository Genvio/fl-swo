...
function tolatlng(usng) {
  
    var usngout = document.getElementById('lat');
    var usngout1 = document.getElementById('long');
    USNGtoLL(usng, latlng);
    usngout.innerText = usngout.textContent = latlng[0]
    usngout1.innerText = usngout.textContent = latlng[1];
}