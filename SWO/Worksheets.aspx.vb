...
Partial Class Worksheets
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        IncidentTypeDataGrid.Columns(0).Visible = False
        ...
        If Page.IsPostBack = False Then
            ...
            Select Case globalMessage
                Case "1"
                    lblMessage.Text = "Worksheet Has Been Added."
                    lblMessage.ForeColor = Drawing.Color.Green
                    lblMessage.Visible = True
                Case "2"
                    lblMessage.Text = "Worksheet Has Been Deleted."
                    lblMessage.ForeColor = Drawing.Color.Green
                    lblMessage.Visible = True
                Case "3"
                    lblMessage.Text = "Worksheet Has Been Updated."
                    lblMessage.ForeColor = Drawing.Color.Green
                    lblMessage.Visible = True
                Case Else
    ...
    Sub PopulateDataGrid()
        ...
        getIncidentType("[IncidentType].[IncidentType] ASC", "", "")
    ...
    Sub IncidentTypeDataGrid_PageIndexChanged(ByVal source As Object, ByVal e As DataGridPageChangedEventArgs)
        ...
        getIncidentType(strSort, ddlSearchBy.SelectedItem.Value, HelpFunction.Convertdbnulls(txtSearch.Text))
    ...
    Private Sub DeleteIncidentType()
        ...
        Catch ex As Exception
            DBConStringHelper.FinalizeConnection(objConn)
            lblMessage.Text = "You may not delete this Worksheet due to the fact it is tied to related imported information. You must first delete all related imported information first, and then you may delete the Worksheet."
            lblMessage.Visible = True
