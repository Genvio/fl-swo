<%@ Page Language="VB" MasterPageFile="~/LoggedIn.master" AutoEventWireup="false" CodeFile="EditExempt.aspx.vb" Inherits="EditExempt" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table width="100%" align="center">
        <tr>
            <td align="center">
                <font size="6">
                    <b><asp:Label ID="lblAddEdit" runat="server" />Exempt</b>
                </font>
            </td>
        </tr>
    </table>
    ...
    <table width="100%" align="center">
        <tr>
            <td align="right" width="40%">
                <b><font size="3">Comments:</font></b>
            </td>
            <td align="left">
                <asp:TextBox ID="txtComments" runat="server" Width="300px" />
            </td>
        </tr>
    </table>
    <table width="100%" align="center">
        <tr>
            ...
            <td align="left">
                <asp:DropDownList ID="ddlIncidentType" DataTextField="IncidentType" DataValueField="IncidentTypeID" runat="server" />
            </td>
        </tr>
    </table>
    <table width="100%" align="center">
