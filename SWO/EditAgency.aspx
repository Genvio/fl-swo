<%@ Page Language="VB" MasterPageFile="~/LoggedIn.master" AutoEventWireup="false" CodeFile="EditAgency.aspx.vb" Inherits="EditAgency" title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table width="100%" align="center">
        <tr>
            <td align="center">
                <font size="6">
                    <b><asp:Label ID="lblAddEdit" runat="server" />Agency</b>
                </font>
            </td>
        </tr>
    </table>
    ...
    <table width="100%" align="center">
        <tr>
            ...
            <td align="left">
                <asp:TextBox ID="txtAgency" runat="server" Width="300px" />
            </td>
        </tr>
    </table>
    <table width="100%" align="center">
        <tr>
            <td align="right" width="40%">
                <b><font size="3">Abbreviation:</font></b>
            </td>
            <td align="left">
                <asp:TextBox ID="txtAbbreviation" runat="server" Width="300px" />
            </td>
        </tr>
    </table>
    <table width="100%" align="center">
