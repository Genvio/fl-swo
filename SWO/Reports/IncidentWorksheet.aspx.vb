...
Partial Class Reports_IncidentWorksheet
    ...
    Public Sub BuildGridView()
        ...
        strOutput.Append("<title>SERT :: SWO :: Incident Worksheet Count</title>")
        ...
        'strOutput.Append("  </tr>")
        strOutput.Append("  <tr>")
        strOutput.Append("      <td colspan='7' align='Center'style='background-color: #eeeeef' >")
        strOutput.Append("          <b><font size='+1'>SERT :: SWO :: Incident Worksheet Count</font></b>")
        strOutput.Append("      </td>")
        strOutput.Append("  </tr>")
        strOutput.Append("  <tr>")
        strOutput.Append("      <td colspan='7' align='Center'  style='background-color: #eeeeef'>" & Now() & "")
        strOutput.Append("      </td>")
        strOutput.Append("")
        strOutput.Append("</tr>")
        ...
        strOutput.Append("<table width='100%' cellspacing='0' border='0' >")
        strOutput.Append("<tr>")
        strOutput.Append("<td align='center' style='background-color: #d4d4d4; border:0;' ><b>Worksheet</b></td>")
        strOutput.Append("<td align='center' style='background-color: #d4d4d4; border:0;'><b>Count</b></td>")
        strOutput.Append("</tr>")
        ...
        If objDR.Read() Then
            ...
            While objDR.Read
                ...
                strOutput.Append("<td align=center>" & objDR.Item("IncidentType") & "</td>")
                strOutput.Append("<td align=center>" & objDR.Item("Count") & "</td>")
                strOutput.Append("</tr>")
            ...
            strOutput.Append("<tr style='background-color: #d4d4d4; border:0;'>")
            strOutput.Append("<td colspan='2' align=center>&nbsp;</td>")
            strOutput.Append("</tr>")
